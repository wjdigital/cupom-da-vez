...
<html lang="pt-BR">
    ...
    <body class="fundoWhite">
        ...
        <div id="p1" style="background-color: #FFFFFF; padding: 15px 0 18px 0;">
            ...
            <img style="width: 35%; margin: auto; margin-left: 10px; position: relative; margin-top: 10px;" src="assets/images/logo2.png" />
        ...
        <div id="produto1" style="width: 100%;">
            <div style="text-align: center; display: flex; justify-content: center; flex-direction: column; align-content: center; flex-wrap: wrap; position: relative;">
                ...
                <div id="textoCodigoEncontrado" style="display: none;">
                    <img src="assets/images/ok.png" class="ok"></h1>
                ...
                <div class="container" id="container">
                    ...
                    <div class="cards">
                            ...
                            <img style="width: 80%;" src="assets/images/produtos/18.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-1" value="22963364" />
                        </label>
                                                <label class="card" for="item-2" id="song-2">
                            <img style="width: 80%;" src="assets/images/produtos/45.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-2" value="47496472" />
                        </label>
                                                <label class="card" for="item-3" id="song-3">
                            <img style="width: 80%;" src="assets/images/produtos/51.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-3" value="98481475" />
                        </label>
                                                <label class="card" for="item-4" id="song-4">
                            <img style="width: 80%;" src="assets/images/produtos/76.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-4" value="66777793" />
                        </label>
                                                <label class="card" for="item-5" id="song-5">
                            <img style="width: 80%;" src="assets/images/produtos/35.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-5" value="12976988" />
                        </label>
                                                <label class="card" for="item-6" id="song-6">
                            <img style="width: 80%;" src="assets/images/produtos/12.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-6" value="95452163" />
                        </label>
                                                <label class="card" for="item-7" id="song-7">
                            <img style="width: 80%;" src="assets/images/produtos/97.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-7" value="67498354" />
                        </label>
                                                <label class="card" for="item-8" id="song-8">
                            <img style="width: 80%;" src="assets/images/produtos/89.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-8" value="27536355" />
                        </label>
                                                <label class="card" for="item-9" id="song-9">
                            <img style="width: 80%;" src="assets/images/produtos/80.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-9" value="55349848" />
                        </label>
                                                <label class="card" for="item-10" id="song-10">
                            <img style="width: 80%;" src="assets/images/produtos/68.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-10" value="87526465" />
                        </label>
                                                <label class="card" for="item-11" id="song-11">
                            <img style="width: 80%;" src="assets/images/produtos/36.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-11" value="52417247" />
                        </label>
                                            </div>
            ...
            <div id="codigoBarras" class="coolinput" style="margin-top: 275px; display: none;">
                ...
                <form action="cupom5.php" method="POST" id="formCupom">     
        ...
        <script src="assets/js/validacaoCodigoBarras.js"></script>
