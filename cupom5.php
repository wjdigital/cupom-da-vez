    ...
    <body class="fundoWhite">
        ...
        <div id="produto1" style="width: 100%;">
            <div style="text-align: center; display: flex; justify-content: center; flex-direction: column; align-content: center; flex-wrap: wrap; position: relative;">
                ...
                <div class="container" id="container">
                    ...
                    <div class="cards">
                            ...
                            <img style="width: 80%;" src="assets/images/produtos/46.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-1" value="66686958" />
                        </label>
                                                <label class="card" for="item-2" id="song-2">
                            <img style="width: 80%;" src="assets/images/produtos/19.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-2" value="31968178" />
                        </label>
                                                <label class="card" for="item-3" id="song-3">
                            <img style="width: 80%;" src="assets/images/produtos/70.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-3" value="96714954" />
                        </label>
                                                <label class="card" for="item-4" id="song-4">
                            <img style="width: 80%;" src="assets/images/produtos/43.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-4" value="68939948" />
                        </label>
                                                <label class="card" for="item-5" id="song-5">
                            <img style="width: 80%;" src="assets/images/produtos/8.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-5" value="55469718" />
                        </label>
                                                <label class="card" for="item-6" id="song-6">
                            <img style="width: 80%;" src="assets/images/produtos/79.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-6" value="18986233" />
                        </label>
                                                <label class="card" for="item-7" id="song-7">
                            <img style="width: 80%;" src="assets/images/produtos/58.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-7" value="15999211" />
                        </label>
                                                <label class="card" for="item-8" id="song-8">
                            <img style="width: 80%;" src="assets/images/produtos/76.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-8" value="66777793" />
                        </label>
                                                <label class="card" for="item-9" id="song-9">
                            <img style="width: 80%;" src="assets/images/produtos/29.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-9" value="46858886" />
                        </label>
                                                <label class="card" for="item-10" id="song-10">
                            <img style="width: 80%;" src="assets/images/produtos/93.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-10" value="88286351" />
                        </label>
                                                <label class="card" for="item-11" id="song-11">
                            <img style="width: 80%;" src="assets/images/produtos/20.jpg" />
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-11" value="39545595" />
                        </label>
                                            </div>
            ...
            <div id="codigoBarras" class="coolinput" style="margin-top: 275px; display: none;">
                ...
                <form action="cupom6.php" method="POST" id="formCupom">     
